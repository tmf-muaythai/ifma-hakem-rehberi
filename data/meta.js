...
window.IFMA.ui = {
  tr: {
    ...
    chiefInstructorLabel: "Baş Eğitmenimiz",
    mhkViceChairQuote: "Hakemlik pratiğini geliştirmek için gölge hakemlik uygulamaları şarttır.",
    mhkChairQuote: "Mükemmel hakem yoktur. Az hata yapan hakem vardır.",
    ...
    promoRefereeText: "İngilizce Muaythai Terimlerini öğrenerek hakemliğini bir üst seviyeye taşımak ister misin?",
    promoRefereeBtn: "ÖĞRENMEYE HEMEN BAŞLA",
  ...
  en: {
    ...
    chiefInstructorLabel: "Our Chief Instructor",
    mhkViceChairQuote: "Shadow refereeing practice is essential to sharpen your skills as a referee.",
    mhkChairQuote: "There is no perfect referee — only one who makes fewer mistakes.",
    ...
    promoRefereeText: "Want to take your refereeing to the next level by learning English Muaythai terms?",
    promoRefereeBtn: "START LEARNING NOW",
